...
import generador_aleatorios as gen
...
class App(b.Window):
    ...
    def proceso_largo(self, params):
        ...
        try:
            ...
            numeros = None
            if params['dist'] == "Uniforme":
                numeros = gen.generar_uniforme(params['n'], params['a'], params['b'])
            elif params['dist'] == "Exponencial":
                numeros = gen.generar_exponencial(params['n'], params['media_exp'])
            elif params['dist'] == "Normal":
                numeros = gen.generar_normal(params['n'], params['media_norm'], params['desviacion'])
